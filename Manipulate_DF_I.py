...
Hint
To create the dictionary, specify the key:value pairs inside {}.
Firt select the 'winner' column of the election DataFrame, and then use the .map() method on it with the dictionary red_vs_blue as argument.
